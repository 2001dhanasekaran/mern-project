    ...
    const addToCart = (product) => {
        ...
        if (existingProductIndex !== -1) {
            ...
            cart.push({
                ...product,
                quantity: 1,
                productImg: product.productImg.startsWith("http") ? product.productImg : `${process.env.REACT_APP_BACKEND_URL}${product.productImg}`
            });
        }
                    ...
                    return (
                        <div key={product._id} className='shadow rounded-4'>
                            <div className='card product-card border-0'>
                                <img
                                    src={product.productImg.startsWith("http") ? product.productImg : `${process.env.REACT_APP_BACKEND_URL}${product.productImg}`}
